...
* **salient-reason argumentation**: by providing a salient principle for truth-sticking
* **consequentialist argumentation**: by taking the value of the consequences as the decisive consideration

### Salient-Principle Argumentation 
...
1. An argument attacking the prima facie reasons supporting truth-telling. In our case there are four pro-truth-sticking reasons. The arguments A1-A4 debunk them:
  * A1: Debunking desire-fulfillment;
  * A2: Debunking respecting-autonomy;
  * A3: Debunking supporing-friendship;
  * A4: Debunking supporting a social practice.

2. The argument supporting the main claim ("You should lie!"). It is reconstructed as **A5: There are no reasons against lying"**. 
...
::: {.callout-warning icon="false" collapse="true"}
#### A5: There are no reasons against lying
...
* **salient-reason argumentation**: by providing a salient principle for lying
* **consequentialist argumentation**: by taking the value of the consequences as the decisive consideration
